...
import io.kubernetes.client.models.V1StatusCauseV2;
...
public class V1StatusDetailsV2 {
  ...
  private List<V1StatusCauseV2> causes = null;
  ...
  public V1StatusDetailsV2 kind(String kind) {
  ...
  **/
  ...
  public V1StatusDetailsV2 group(String group) {
  ...
  **/
  ...
  public V1StatusDetailsV2 name(String name) {
  ...
  **/
  ...
  public V1StatusDetailsV2 retryAfterSeconds(Integer retryAfterSeconds) {
  ...
  **/
  ...
  public V1StatusDetailsV2 causes(List<V1StatusCauseV2> causes) {
    
    this.causes = causes;
    return this;
  }

  public V1StatusDetailsV2 addCausesItem(V1StatusCauseV2 causesItem) {
    if (this.causes == null) {
      this.causes = new ArrayList<V1StatusCauseV2>();
    }
  ...
  **/
  ...
  public List<V1StatusCauseV2> getCauses() {
    return causes;
  }


  public void setCauses(List<V1StatusCauseV2> causes) {
    this.causes = causes;
  }


  public V1StatusDetailsV2 uid(String uid) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1StatusDetailsV2 v1StatusDetailsV2 = (V1StatusDetailsV2) o;
    return Objects.equals(this.kind, v1StatusDetailsV2.kind) &&
        Objects.equals(this.group, v1StatusDetailsV2.group) &&
        Objects.equals(this.name, v1StatusDetailsV2.name) &&
        Objects.equals(this.retryAfterSeconds, v1StatusDetailsV2.retryAfterSeconds) &&
        Objects.equals(this.causes, v1StatusDetailsV2.causes) &&
        Objects.equals(this.uid, v1StatusDetailsV2.uid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kind, group, name, retryAfterSeconds, causes, uid);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1StatusDetailsV2 {\n");
