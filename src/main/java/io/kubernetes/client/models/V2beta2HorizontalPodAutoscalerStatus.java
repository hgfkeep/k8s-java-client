...
public class V2beta2HorizontalPodAutoscalerStatus {
  ...
  private List<V2beta2HorizontalPodAutoscalerCondition> conditions = new ArrayList<V2beta2HorizontalPodAutoscalerCondition>();
  ...
  **/
  ...
  public V2beta2HorizontalPodAutoscalerStatus addCurrentMetricsItem(V2beta2MetricStatus currentMetricsItem) {
    if (this.currentMetrics == null) {
      this.currentMetrics = new ArrayList<V2beta2MetricStatus>();
    }
  ...
  **/
  ...
  public V2beta2HorizontalPodAutoscalerStatus lastScaleTime(DateTime lastScaleTime) {
